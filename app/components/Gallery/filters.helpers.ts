import { CONTENT_TYPES, type ContentType, type GalleryCard } from "@/app/site-config/types";
...
export function filterByContentType(items: GalleryCard[], type: ContentType | null): GalleryCard[] {
