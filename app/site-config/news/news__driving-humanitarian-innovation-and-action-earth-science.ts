...
export const NEWS__DRIVING_HUMANITARIAN_INNOVATION_EARTH_SCIENCE: NewsContent = {
  ...
  thumbnailImage: {
    src: "/img/news/driving-humanitarian-innovation.webp",
    alt: "A brightly colored NASA Lifelines mural depicting a satellite, a city street and metro bus, a bird in flight, children pointing at a map of Washington, D.C., and a group of people working together under a satellite map",
  },
  mastheadImage: {
    src: "/img/news/driving-humanitarian-innovation.webp",
    alt: "A brightly colored NASA Lifelines mural depicting a satellite, a city street and metro bus, a bird in flight, children pointing at a map of Washington, D.C., and a group of people working together under a satellite map",
  ...
  body: [
    ...
    {
      type: "image",
      src: "/img/news/driving-humanitarian-innovation__mural-unveiling.webp",
    ...
    {
      type: "image",
      src: "/img/news/driving-humanitarian-innovation__ready-for-impact.webp",
    ...
    {
      type: "text",
      heading: "Welcome to the NASA Lifelines Galaxy",
      headingLevel: "h2",
      paragraphs: [
    ...
    {
      type: "image",
      src: "/img/news/driving-humanitarian-innovation__lifelines-galaxy.webp",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Shaping the programming are Advisors, experts bringing their depth of experience to guide the strategy of the initiative, and Fellows who bring new perspectives as they amplify program operations.",
      ],
    },
    {
      type: "text",
      heading: "Building a Community of Action",
      headingLevel: "h2",
      paragraphs: [
    ...
    {
      type: "image",
      src: "/img/news/driving-humanitarian-innovation__speed-dating.webp",
    ...
    {
      type: "image",
      src: "/img/news/driving-humanitarian-innovation__supper-club.webp",
    ...
    {
      type: "text",
      heading: "Continuing to Weave the NASA Lifelines Community",
      headingLevel: "h2",
      paragraphs: [
    ...
    },
    {
      ...
      items: [
        {
          label: "Learn more and join the Humanitarian Simulation",
          href: "https://nasalifelines.org/humanitarian-simulations/",
        },
        { label: "NASA Lifelines website", href: "https://nasalifelines.org/" },
        {
          label: "NASA Lifelines on LinkedIn",
          href: "https://www.linkedin.com/company/nasalifelines",
        },
        { label: "NASA Lifelines on Instagram", href: "https://www.instagram.com/nasalifelines/" },
      ],
    },
  ],
};
