...
export const STORY__STRENGTHENING_SEVERE_WEATHER_READINESS: StoryContent = {
  id: "strengthening-severe-weather-readiness-through-science",
  contentType: "story",
  title: "Strengthening Severe Weather Readiness Through Science",
  date: "2025-04-29",
  description:
  ...
  body: [
    ...
    {
      type: "text",
      heading: "Predicting Severe Storms to Protect Lives and Property",
      paragraphs: [
    ...
    {
      type: "text",
      heading: "Protecting Roads and Communities from Hurricane Devastation",
      paragraphs: [
    ...
    {
      type: "text",
      heading: "Keeping the Lights on in the Face of Storms",
      paragraphs: [
    ...
    },
    {
      ...
      items: [
        {
          label: "NASA Selects Seven New Projects to Advance Disaster Science",
          href: "/news-events/nasa-selects-seven-new-projects-advance-disaster-science",
        },
      ],
    },
  ],
