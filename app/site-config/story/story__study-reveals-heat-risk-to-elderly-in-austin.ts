import { TRAINING__SATELLITE_REMOTE_SENSING_URBAN_HEAT_ISLANDS } from "@/app/site-config/training/training__satellite-remote-sensing-urban-heat-islands";
...
export const STORY__STUDY_REVEALS_HEAT_RISK_ELDERLY_AUSTIN: StoryContent = {
  ...
  body: [
    ...
    },
    {
      ...
      items: [
        {
          label: "Read the full study in Building and Environment",
          href: "https://www.sciencedirect.com/science/article/pii/S0360132325015367?via%3Dihub",
        },
      ],
    },
    {
      ...
      cards: [TRAINING__SATELLITE_REMOTE_SENSING_URBAN_HEAT_ISLANDS],
    },
  ],
};
